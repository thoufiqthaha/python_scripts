...
INFORMATION:
------------------------------------------------------------------------
THIS IS TO AUTO PUSH/PULL CONFIG FOR THE SSH BASED DEVICE. 

 >> UPDATE THE HOST LISTS FROM THE FILE "devices.txt" 
 >> UPDATE THE CONFIG/COMMANDS IN THE FILE "config.txt" 
 >> THE OUTPUT OF THE SCRIPT WILL BE SAVED IN THE FILE "output.txt"
------------------------------------------------------------------------
"""

#Banner

bannertext=("THIS IS TO AUTO PUSH/PULL CONFIG FOR THE SSH BASED DEVICE. \n\n >> UPDATE THE HOST LISTS FROM THE FILE \"devices.txt\" \n >> UPDATE THE CONFIG/COMMANDS IN THE FILE \"config.txt\" \n >> THE OUTPUT OF THE SCRIPT WILL BE SAVED IN THE FILE \"output.txt\"")
bannerout = terminal_banner.Banner(bannertext)
print ("\n")
print (bannerout)
...
print("0 - Other Hosts (Specific IP)\n")
